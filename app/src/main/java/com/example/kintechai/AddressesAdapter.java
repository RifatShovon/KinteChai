...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.Viewholder> {
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        private void setData(String userName, String city, String userPincode, Boolean selected, final int position, String mobileNo, String alternateMobileNo, String flatNo, final String locality, String landmark) {
